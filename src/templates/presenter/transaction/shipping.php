...
<div id="lwcommerce-shipping" class="swiper-slide">
    ...
    <form class="full-height">
        ...
        <?php if ($digital_shipping) : ?>
            <h6 style="margin-bottom:12px;" class="text-primary"><?php _e('Digital Shipping', 'lwcommerce'); ?></h6>
                ...
                <div class="col-sm-6 col-xs-12 gutter swiper-no-swiping">
                    ...
                    <div class="lokuswp-form-group">
                        <div class="item-radio">
                            <input type="radio" name="email_courier" id="email" checked>
                            <label class="svg-wrapper">
                                ...
                                <span><?php _e("Email", 'lwcommerce'); ?></span>
                            </label>
                        </div>
                    </div>
                </div>
                <label style="padding:12px 8px"><?php _e('Digital Products will be sent via the channel above', 'lwcommerce'); ?></label>
            </div>
        <?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 swiper-no-swiping gutter">
            <div class="lsdp-form-group">
                <div class="item-radio">
                    <input type="radio" name="shipping_channel" id="{{service}}" title="{{short_name}}"

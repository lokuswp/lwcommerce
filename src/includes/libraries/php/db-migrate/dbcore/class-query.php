...
class Query {
     ...
     * Constructor
     *
     * @param string|ActiveRecord  $model   (optional) A class name of a \ActiveRecord class or a table name
    ...
    public function execute($sql="") {
        ...
        return empty($sql) ? static::wpdb()->query($this->sql()) : static::wpdb()->get_results($sql,'ARRAY_A') ;

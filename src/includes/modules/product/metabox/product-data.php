                ...
                <div id="tab-content-stock" class="tab-entry tab-content-stock">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <div class="form-group-body">
                                <select id="lokuswp-product-stock-availability" name="_stock_availability"
                        ...
                        <div class="row nowrap col-12 right-clear">
                            ...
                            <div class="form-group col-6 right-clear">
                                ...
                                <div class="form-group-body">
                                    <select id="lokuswp-product-stock-availability" name="_stock_availability"
                                            class="form-select full">
                                        <option value="minute"><?php _e( "Menit", 'lwcommerce' ); ?></option>
                                        <option value="hour"><?php _e( "Jam", 'lwcommerce' ); ?></option>
                                        <option value="day"><?php _e( "Hari", 'lwcommerce' ); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>

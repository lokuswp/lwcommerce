            ...
            <div class="form-group">
                ...
                <div class="form-group-body">
                    <select class="form-select full" id="lokuswp-product-type" name="_product_type">
                        <option selected="selected" value="physical"><?php _e("Physical Product", 'lwcommerce'); ?></option>
                ...
                <div id="tab-content-digital-product" class="tab-entry product-type-tab-entry tab-content-digital-product">
                    <div class="action-group" style="display:none">
                        ...
                        <div class="action">
                            ...
                            <button id="btn-product-attachment" class="button btn-product-attachment btn-upload"><?php _e("Upload File", 'lwcommerce'); ?></button>
                        </div> <!-- action -->
                    </div> <!-- action-group -->

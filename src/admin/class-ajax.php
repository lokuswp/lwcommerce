...
class AJAX {
	...
	public function order_action() {
		...
		$shipping_type = isset( $_POST['shipping_type'] ) ? sanitize_text_field( $_POST['shipping_type'] ) : null;
		$courier       = isset( $_POST['courier'] ) ? sanitize_text_field( $_POST['courier'] ) : null;

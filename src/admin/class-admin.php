...
class Admin
{
    ...
    public function enqueue_styles()
    {
        ...
        if (isset($_GET['page'])) {
            if ($_GET['page'] == 'lwpcommerce' || strpos($_GET['page'], 'lsdc-') !== false) {
                ...
                wp_enqueue_style('spectre-exp', LWPC_URL . 'backend/assets/lib/spectre/spectre-exp.min.css', array(), '0.5.8', 'all');
                wp_enqueue_style('spectre-icons', LWPC_URL . 'backend/assets/lib/spectre/spectre-icons.min.css', array(), '0.5.8', 'all');
                wp_enqueue_style('spectre', LWPC_URL . 'backend/assets/lib/spectre/spectre.min.css', array(), '0.5.8', 'all');
    ...
    public function enqueue_scripts()
    {
        ...
        if (isset($_GET['page']) && $_GET['page'] == 'lwpcommerce' || strpos(get_post_type(get_the_ID()), 'lsdc-') !== false || isset($_GET['page']) && strpos($_GET['page'], 'lsdc-') !== false) {
            // Load Admin Js

...
<?php if ( $shipping_active ) : ?>
    ...
    <ul class="methods" id="draggable">
		...
		foreach ( $shipping_active as $shipping_id ) :
			...
			$shipping_data =  lwp_get_option( $shipping_id );
                    ...
                    <li class="shipping-channel" draggable="true" style="vertical-align:middle">
                        <div class="services columns col-gapless">
                            ...
                            <div class="column col-3 method"
                                ...
                                <img src="<?php echo esc_url( $shipping_data->logo ); ?>" alt="<?= $shipping_data->name ?>"
                            ...
                            <div class="column col-2" style="display: flex; justify-content: center">
                                <div class="form-group">
                                    ...
                                    <label class="form-switch">
                                        <input type="checkbox"
                                               id="<?php echo $shipping_id; ?>" <?php echo ( $shipping_obj->get_status() == 'on' ) ? 'checked' : ''; ?>>
                            ...
                            <?php foreach ( $shipping_data->package as $key => $package ) : ?>
                                ...
                                <label class="form-checkbox">
                                    <input type="checkbox" checked=""><i
                                            class="form-icon"></i><?php esc_attr_e( ucfirst( $key ) ) ?>
                                </label>
                ...
                <div class="tab-body-wrapper">
                    ...
                    <div id="tab-body-log" class="tab-body">
                        ...
                        <div class="input-group" style="width:50%;">
                            <input id="lwcommerce_email_test" style="margin-top:3px;" class="form-input input-md"
                                   type="email" placeholder="email@gmail.com">
                            <button id="lwcommerce_email_sendtest" style="margin-top:3px;"
                                    class="btn btn-primary input-group-btn"><?php _e( 'Test Email', 'lwcommerce' ); ?></button>
                        </div>
                        <br>
                                ...
                                <div class="form-group">
                                    <div class="col-3 col-sm-12">
                                        <label class="form-label"
                                               for="subject"><?php _e( 'Subject', 'lwcommerce' ); ?></label>
                                    </div>
                                    <div class="col-5 col-sm-12">
                                        <input type="text" class="form-input" name="subject"
                                               placeholder="<?php _e( "Digital Product Delivery", "lwcommerce" ); ?>"
                                               value=""/>
                                    </div>
                                </div>
                    ...
                    <div id="tab-body-settings" class="tab-body">
                        <form class="form-horizontal" block="settings">
                            ...
                            <div class="form-group">
                                <div class="col-3 col-sm-12">
                                    <label class="form-label"
                                           for="country"><?php _e( 'Sender', 'lwcommerce' ); ?></label>
                                </div>
                                <div class="col-9 col-sm-12">
                                    <input class="form-input" type="text" name="sender" placeholder="LokusWP"
                                           style="width:320px" value="<?php echo $this->sender; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-3 col-sm-12">
                                    <label class="form-label"
                                           for="country"><?php _e( 'Sender Email', 'lwcommerce' ); ?></label>
                                </div>
                                <div class="col-9 col-sm-12">
                                    <input class="form-input" type="email" name="sender_email"
                                           placeholder="noreply@lwcommerce.com" style="width:320px"
                                           value="<?php echo $this->sender_email; ?>">
                                </div>
                            </div>

                            <button class="btn btn-primary lwcommerce_admin_option_save"
                                    option="lwcommerce_notification_email" style="width:120px">
